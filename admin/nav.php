...
<ul class="nav nav-pills nav-stacked side-menu">
    ...
    <li>
        <a href="#">Users <span class="glyphicon glyphicon-menu-right pull-right"></span></a>
        <ul class="nav ">
    ...
    <li>
        <a href="#">Tin tức <span class="glyphicon glyphicon-menu-right pull-right"></span></a>
        <ul class="nav ">
            <li><a href="#">Xem danh sách</a></li>
            <li><a href="#">Thêm mới</a></li>
        </ul>
    </li>
    <li><a href="#">Logout <span class="glyphicon glyphicon-menu-right pull-right"></span></a></li>
</ul>