...
if(isset($_POST['suasanpham'])) $qt->suasanpham($_GET['idSP']);
...
<div class="">
    ...
    <div class="col-md-6" style="padding-left: 20px;">
        ...
        <div class="form-group">
            ...
            <textarea name="MoTa" class="form-control" rows="3"><?php echo $sanpham['MoTa'];?></textarea>
        </div>
        
        <div class="form-group">
            <label for="baiviet">Bài viết</label>
            <textarea name="baiviet" class="form-control" rows="6"><?php echo $sanpham['baiviet'];?></textarea>
        </div>
    </div>
